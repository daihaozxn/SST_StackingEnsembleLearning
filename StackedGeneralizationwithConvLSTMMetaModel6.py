...
def fit_stacked_model(stackedX, inputy, n_layers, n_steps, n_rows, n_cols, dropout_rate, filters, kernel_size, n_outputs):
    ...
    temp = curtime + '_ConvLSTMStacking_best_model.h5'
...
# plt.plot(raw_train[:, 0, 0], 'k-')
# plt.xlim(0, 14000)
# plt.ylim(12.5, 32.5)
# plt.tick_params(labelsize=12)
# plt.xlabel('时间(Day)', fontsize=14)
# plt.ylabel('海表温度(℃)', fontsize=14)
# plt.show()
...
# plt.rcParams['xtick.direction'] = 'in'
# plt.rcParams['ytick.direction'] = 'in'
# plt.plot(raw_train_scaled[:, 0], 'k-')
# plt.xlim(0, 14000)
# plt.ylim(-4, 3)
# plt.tick_params(labelsize=12)
# plt.xlabel('时间(Day)', fontsize=14)
# plt.ylabel('高斯归一化后值', fontsize=14)
# plt.show()

# 将SST时空序列数据转换为 监督学习问题
# X_train_valid和X_test的形状是[samples, n_steps, row*col], y_train_valid和y_test的形状是[samples,row*col]
# X_train_valid.shape=(samples, n_steps, n_rows, n_cols, 1)   y_train_valid.shape=(samples, n_rows, n_cols, 1)
# X_test.shape=(samples, n_steps, n_rows, n_cols, 1)   y_test.shape=(samples, n_rows, n_cols, 1)
...
# lead_time = 1
# 东海    选出每个子模型中最差的一个
# model_MLP = load_model('Submodels/DH_lead_time_1/model_MLP_65.h5')
# model_LSTM = load_model('Submodels/DH_lead_time_1/model_LSTM_13.h5')
# model_CNN = load_model('Submodels/DH_lead_time_1/model_CNN_43.h5')
# model_CNNLSTM = load_model('Submodels/DH_lead_time_1/model_CNNLSTM_50.h5')

# model_MLP = load_model('Submodels/DH_lead_time_1/20220327103652_MLP_best_model.h5')
# model_LSTM = load_model('Submodels/DH_lead_time_1/20220327113030_LSTM_best_model.h5')
# model_CNN = load_model('Submodels/DH_lead_time_1/20220327162856_CNN_best_model.h5')
# model_CNNLSTM = load_model('Submodels/DH_lead_time_1/20220327181425_CNNLSTM_best_model.h5')

# 东海2    选出每个子模型中最差的一个
# model_MLP = load_model('Submodels/DH2_lead_time_1/model_MLP_62.h5')
# model_LSTM = load_model('Submodels/DH2_lead_time_1/model_LSTM_8.h5')
# model_CNN = load_model('Submodels/DH2_lead_time_1/model_CNN_25.h5')
# model_CNNLSTM = load_model('Submodels/DH2_lead_time_1/model_CNNLSTM_49.h5')
...
# 选出每个子模型中最差的一个
# model_MLP = load_model('Submodels/lead_time_1/model_MLP_9.h5')
# model_LSTM = load_model('Submodels/lead_time_1/model_LSTM_89.h5')
# model_CNN = load_model('Submodels/lead_time_1/model_CNN_65.h5')
# model_CNNLSTM = load_model('Submodels/lead_time_1/model_CNNLSTM_97.h5')
# 选出每个子模型中  中间的一个（按照rmse升序排列后编号49的那个）
# model_MLP = load_model('Submodels/lead_time_1/model_MLP_73.h5')
# model_LSTM = load_model('Submodels/lead_time_1/model_LSTM_38.h5')
# model_CNN = load_model('Submodels/lead_time_1/model_CNN_27.h5')
# model_CNNLSTM = load_model('Submodels/lead_time_1/model_CNNLSTM_64.h5')

# model_ConvLSTM = load_model('Submodels/model_ConvLSTM_85.h5')
# lead_time = 3
# 最差
# model_MLP = load_model('Submodels/lead_time_3/model_MLP_26.h5')
# model_LSTM = load_model('Submodels/lead_time_3/model_LSTM_76.h5')
# model_CNN = load_model('Submodels/lead_time_3/model_CNN_51.h5')
# model_CNNLSTM = load_model('Submodels/lead_time_3/model_CNNLSTM_38.h5')
# 最好
...
# lead_time = 5
# 最差
# model_MLP = load_model('Submodels/lead_time_5/model_MLP_47.h5')
# model_LSTM = load_model('Submodels/lead_time_5/model_LSTM_42.h5')
# model_CNN = load_model('Submodels/lead_time_5/model_CNN_70.h5')
# model_CNNLSTM = load_model('Submodels/lead_time_5/model_CNNLSTM_37.h5')
# 最好
...
# lead_time = 7
# 最差
# model_MLP = load_model('Submodels/lead_time_7/model_MLP_78.h5')
# model_LSTM = load_model('Submodels/lead_time_7/model_LSTM_49.h5')
# model_CNN = load_model('Submodels/lead_time_7/model_CNN_73.h5')
# model_CNNLSTM = load_model('Submodels/lead_time_7/model_CNNLSTM_4.h5')
# 最好
...
# plt.rcParams['xtick.direction'] = 'in'
# plt.rcParams['ytick.direction'] = 'in'
# plt.plot(inv_yhat_test_MLP[:, 0], 'k+', inv_y_test[:, 0], 'k-')
# plt.xlim(0, 362)
# plt.ylim(18, 30)
# plt.tick_params(labelsize=12)
# plt.xlabel('时间(Day)', fontsize=14)
# plt.ylabel('海表温度(℃)', fontsize=14)
# plt.legend(['MLP预测值', '观测值'])
# plt.show()
...
# plt.rcParams['xtick.direction'] = 'in'
# plt.rcParams['ytick.direction'] = 'in'
# plt.plot(inv_yhat_test_LSTM[:, 0], 'ko', markerfacecolor='none')
# plt.plot(inv_y_test[:, 0], 'k-')
# plt.xlim(0, 362)
# plt.ylim(18, 30)
# plt.tick_params(labelsize=12)
# plt.xlabel('时间(Day)', fontsize=14)
# plt.ylabel('海表温度(℃)', fontsize=14)
# plt.legend(['LSTM预测值', '观测值'])
# plt.show()
...
# plt.rcParams['xtick.direction'] = 'in'
# plt.rcParams['ytick.direction'] = 'in'
# plt.plot(inv_yhat_test_CNN[:, 0], 'k*', inv_y_test[:, 0], 'k-')
# plt.xlim(0, 362)
# plt.ylim(18, 30)
# plt.tick_params(labelsize=12)
# plt.xlabel('时间(Day)', fontsize=14)
# plt.ylabel('海表温度(℃)', fontsize=14)
# plt.legend(['CNN预测值', '观测值'])
# plt.show()
...
# plt.rcParams['xtick.direction'] = 'in'
# plt.rcParams['ytick.direction'] = 'in'
# plt.plot(inv_yhat_test_CNNLSTM[:, 0], 'kx', inv_y_test[:, 0], 'k-')
# plt.xlim(0, 375)
# plt.ylim(18, 30)
# plt.tick_params(labelsize=12)
# plt.xlabel('时间(Day)', fontsize=14)
# plt.ylabel('海表温度(℃)', fontsize=14)
# plt.legend(['CNNLSTM预测值', '观测值'])
# plt.show()

# ConvLSTM
# yhat_test_ConvLSTM = model_ConvLSTM.predict(X_test_ConvLSTM)
# yhat_test_ConvLSTM = yhat_test_ConvLSTM.reshape(-1, yhat_test_ConvLSTM.shape[1]*yhat_test_ConvLSTM.shape[2]*yhat_test_ConvLSTM.shape[3])
# inv_yhat_test_ConvLSTM = scaler.inverse_transform(yhat_test_ConvLSTM)
# rmse_test_ConvLSTM = mean_squared_error(inv_y_test, inv_yhat_test_ConvLSTM, squared=False)
# print('rmse_test_ConvLSTM: %.3f ℃' % rmse_test_ConvLSTM)
...
print('rmse_test_ModelsWeightAve: %.3f ℃' % rmse_test_ModelsWeightAve)
...
if path.exists('sub-models_ConvLSTMStacking'):
    rmtree('sub-models_ConvLSTMStacking')
makedirs('sub-models_ConvLSTMStacking')

# model_ConvLSTMStacking = load_model('Submodels/model_ConvLSTMStacking_98.h5')
# yhat = stacked_prediction(stackX_test, model_ConvLSTMStacking, n_rows, n_cols)
# inv_yhat = scaler.inverse_transform(yhat.reshape(-1, yhat.shape[1] * yhat.shape[2] * yhat.shape[3]))
# rmse_test_ConvLSTMStacking = mean_squared_error(inv_y_test, inv_yhat, squared=False)
# print('rmse_test_ConvLSTMStacking: %.3f ℃' % rmse_test_ConvLSTMStacking)
# plt.figure()
# plt.rcParams['font.sans-serif']=['SimHei']
# plt.rcParams['axes.unicode_minus']=False
# plt.rcParams['xtick.direction'] = 'in'
# plt.rcParams['ytick.direction'] = 'in'
# plt.plot(inv_yhat[:, 0], 'ks', markerfacecolor='none', markeredgecolor='black')
# plt.plot(inv_y_test[:, 0], 'k-')
# plt.xlim(0, 370)
# plt.ylim(18, 30)
# plt.tick_params(labelsize=12)
...
for i in range(n_members):
    ...
    filename = 'sub-models_ConvLSTMStacking/model_ConvLSTMStacking_' + str(i + 1) + '.h5'
    model.save(filename)
    ...
    rmse_test_temp = mean_squared_error(inv_y_test, inv_yhat, squared=False)
    # print('rmse_test: %.3f ℃' % rmse_test)
...
for i in range(n_members):
    ...
    rmse_test_ModelsAve_new.append(rmse_test_ModelsAve)
    rmse_test_ModelsWeightAve_new.append(rmse_test_ModelsWeightAve)
# 存各个 rmse
# rmse = [rmse_test_MLP, rmse_test_LSTM, rmse_test_CNN, rmse_test_CNNLSTM, rmse_test_ModelsAve, rmse_test_ModelsWeightAve_new, rmse_test]
rmse = {'MLP': rmse_test_MLP_new,
        'LSTM': rmse_test_LSTM_new,
        'CNN': rmse_test_CNN_new,
        'CNNLSTM': rmse_test_CNNLSTM_new,
        'Ave': rmse_test_ModelsAve_new,
        'ModelsWeightAve': rmse_test_ModelsWeightAve_new,
        'ConvLSTMStacking': rmse_test}
dt_rmse = DataFrame(rmse)
dt_rmse.to_csv('ConvLSTMStacking_rmse_Total.csv', index=False, header=True)