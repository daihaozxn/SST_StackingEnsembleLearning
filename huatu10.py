...
## 包括 persistent model 和 weighted average
...
WeightedAvg_RMSE_TaiwanStrait = data_TaiwanStrait.values[6,0::2]
WeightedAvg_CE_TaiwanStrait = data_TaiwanStrait.values[6,1::2]
...
WeightedAvg_RMSE_EastChinaSea = data_EastChinaSea.values[6,0::2]
WeightedAvg_CE_EastChinaSea = data_EastChinaSea.values[6,1::2]
...
labels = ['WeighAvg', 'Persist', 'MLP', 'LSTM', 'CNN', 'CNNLSTM', 'Stacking']
# labels = ['MLP', 'LSTM', 'CNN', 'CNNLSTM', 'Stacking']
# RMSE for Taiwan Strait
axs[0, 0].set_xlim(0.5, 7.5)
axs[0, 0].plot(lead_time, WeightedAvg_RMSE_TaiwanStrait, 'cv-', linewidth=1.5, markersize=10)
...
axs[0, 0].legend(loc='best', labels=labels, prop={'size': 14})
# CE for Taiwan Strait
axs[0, 1].set_xlim(0.5, 7.5)
axs[0, 1].plot(lead_time, WeightedAvg_CE_TaiwanStrait, 'cv-', linewidth=1.5, markersize=10)
...
axs[0, 1].legend(loc='best', labels=labels, prop={'size': 14})
# RMSE for East China Sea
axs[1, 0].set_xlim(0.5, 7.5)
axs[1, 0].plot(lead_time, WeightedAvg_RMSE_EastChinaSea, 'cv-', linewidth=1.5, markersize=10)
...
axs[1, 0].legend(loc='best', labels=labels, prop={'size': 14})
# CE for East China Sea
axs[1, 1].set_xlim(0.5, 7.5)
axs[1, 1].plot(lead_time, WeightedAvg_CE_EastChinaSea, 'cv-', linewidth=1.5, markersize=10)
...
axs[1, 1].legend(loc='best', labels=labels, prop={'size': 14})
